...
print("10 + 5 =", result)`,
   ...
   "Variables and Data Types":`
# Example 1: Print the values of the variables
...
my_variable_2 = 20  # This is also valid
  # 2nd_variable = 30  # This is invalid (cannot start with a number)`,

     "String Operations and Methods":` 
# Example 1: Creating and Manipulating Strings
...
# Example 4: Escape Characters and Raw Strings
...
# Example 3: Built-in Mathematical Functions
...
# Example 4: Working with Integers and Floating-Point Numbers
...
`,
     ...
     "Input and Output":`
# Exmaple 1: Getting User Input with input() Function
...
# Example 2: Converting Input Strings to Numbers
...
# Example 3: Formatting Output with print() Function
name = "Charlie"
age = 25
job = "developer"
...
# Example 4: Understanding Input Validation Basics
try:
  ...
  #This block runs if a ValueError occurs
    print("Invalid input. Please enter a numerical value.")`,
       ...
       "Lists-Creation and Basic Operations":`
# Example 1: Understanding Lists as Ordered Collections

# Example 2: Creating Lists and Accessing Elements
 #A list of strings
...
# Example 3: List Indexing (Positive and Negative)
letters = ["a", "b", "c", "d", "e"]
...
# Example 4: Basic List Operations: append, insert, remove
...
"List Methods and Advanced Operations":`
# Example 1: Essential list methods: sort, reverse, count, index
...
# Example 2: List Comprehensions for Creating Lists
...
# Example 3: Copying Lists vs. Referencing
original = [1, 2, 3]
...
for row in matrix:
    ...
    print() #Print a newline after each row`,
      ...
      "Tuples and Their Uses":`
# Example 1: Understanding Tuples as Immutable Sequences
#Creating a tuple
...
# Example 2: When to Use Tuples vs. Lists
...
# Example 4: Named Tuples for Structured Data
...
# Example 1: Understanding Dictionaries as Key-Value Mappings
...
# Example 2: Creating and Accessing Dictionary Data
person = {
    "name": "Alice",
    "age": 30,
    "city": "New York"
...
# Example 4: Adding, Updating, and Removing Dictionary Entries
car = {
    "brand": "Ford",
    "model": "Mustang",
    "year": 1964
...
print(f"Final dictionary: {car}")`,
    ...
    "Sets - Unique Collections":`
# Example 1: Understanding Sets as Unordered Collections of Unique Items
...
# Example 3: When to Use Sets for Data Deduplication
...
# Example 4: Frozen Sets for Immutable Collections
...
`,
    ...
    "Conditional Statements - if, elif, else":`
# Example 1: Boolean Logic and Comparison Operators
x = 10
y = 5
...
# Example 2: if, elif, else Statement Structure
score = 85
...
# Example 4: Combining Conditions with and, or, not
...
if not is_full:
    ...
    print("The parking lot is full.")`,
      ...
      "Loops - for and while":`
# Example 1: Understanding Iteration and Repetition

# Example 2: for Loops with Ranges and Collections
...
# Example 3: while Loops for Condition-Based Repetition
...
# Example 4: Loop Control: break and continue
...
# Example 1: Defining Functions with the def Keyword
...
# Example 3: Return Values and return Statement
...
# Example 4: Local vs. Global Scope Basics
...
# Example 1: Positional Arguments vs. Keyword Arguments
...
# Example 2: *args and **kwargs for Flexible Parameters
...
# Example 3: Function Annotations for Documentation
...
# Example 4: Lambda Functions for Simple Operations
...
# Example 1: Importing Modules and Specific Functions
...
# Example 2: Standard Library Modules
...
# Example 3: Creating Your Own Modules
...
# Example 4: Creating Your Own Modules in a separate file
...
# Example 5: Understanding Python Packages
my_project/
├── main.py
└── utils/
    ├── __init__.py
...
# Example 4: File Modes and Context Managers
...
# Example 1: Understanding Exceptions and Error Types
...
# Example 2: try, except, else, finally Blocks
...
# Example 1: Understanding Classes as Blueprints for Objects
...
# Example 2: Creating Classes with _ _init_ _ Method
...
# Example 3: Instance Variables and Methods
...
print(f"Employee 2's company: {emp2.company}")`,
      ...
      "Inheritance and Method Overriding":`
# Example 1: Understanding Inheritance Relationships


# Example 2: Creating Child Classes that Inherit from Parent Classes
...
# Example 3: Method Overriding and super() Function
...
# Example 4: Multiple Inheritance Basics
...
# Example 3: Property Decorators for Controlled Access
...
# Example 4: Data Validation in Classes
`,
...
### Example 2
**Creating Classes with _ _init_ _ Method**
